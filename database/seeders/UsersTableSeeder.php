...
class UsersTableSeeder extends Seeder
{
    ...
    {
        $admin = $this->createUser(UserType::Admin, 'Owner', 'tigermm', '09123456789');
        (new WalletService)->deposit($admin, 10 * 100_000, TransactionName::CapitalDeposit);

        $master = $this->createUser(UserType::Master, 'Master', 'M898976', '09999999999', $admin->id);
        (new WalletService)->transfer($admin, $master, 5 * 100_000, TransactionName::CreditTransfer);

        $agent_1 = $this->createUser(UserType::Agent, 'Agent 1', 'A898737', '09112345674', $master->id, 'vH4HueE9');
