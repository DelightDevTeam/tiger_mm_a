        ...
        <div class="card-body">
          <form role="form" class="text-start" method='post' action="{{route('admin.player.update',$player->id)}}">
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="account_name" class="form-control" value="{{$player->banks[0]['account_name'] }}" placeholder="Enter Bank Account Name">
              @error('account_name')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
            <div class="custom-form-group">
              ...
              <input type="text" name="account_number" class="form-control" value="{{$player->banks[0]['account_number']}}" placeholder="Enter Bank Account Number">
